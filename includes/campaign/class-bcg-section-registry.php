		...
		return array(
			...
			'divider' => array(
				...
				'fields' => array(
					array(
						'key'     => 'line_style',
						'label'   => __( 'Line Style', 'brevo-campaign-generator' ),
						'type'    => 'select',
						'default' => 'solid',
						'options' => array(
							array( 'value' => 'solid',  'label' => __( 'Solid', 'brevo-campaign-generator' ) ),
							array( 'value' => 'dashed', 'label' => __( 'Dashed', 'brevo-campaign-generator' ) ),
							array( 'value' => 'dotted', 'label' => __( 'Dotted', 'brevo-campaign-generator' ) ),
							array( 'value' => 'double', 'label' => __( 'Double', 'brevo-campaign-generator' ) ),
						),
					),
			...
			'social' => array(
				...
				'fields' => array(
					...
					array( 'key' => 'logo_url',     'label' => __( 'Logo (optional)', 'brevo-campaign-generator' ),         'type' => 'image',  'default' => '' ),
					array( 'key' => 'logo_link',    'label' => __( 'Logo Link URL', 'brevo-campaign-generator' ),           'type' => 'text',   'default' => '' ),
					array(
						'key'     => 'logo_side',
						'label'   => __( 'Logo Position', 'brevo-campaign-generator' ),
						'type'    => 'select',
						'default' => 'left',
						'options' => array(
							array( 'value' => 'none',   'label' => __( 'No Logo', 'brevo-campaign-generator' ) ),
							array( 'value' => 'left',   'label' => __( 'Logo Left', 'brevo-campaign-generator' ) ),
							array( 'value' => 'right',  'label' => __( 'Logo Right', 'brevo-campaign-generator' ) ),
						),
					),
					array(
						'key'     => 'icon_side',
						'label'   => __( 'Icons Alignment', 'brevo-campaign-generator' ),
						'type'    => 'select',
						'default' => 'centre',
						'options' => array(
							array( 'value' => 'left',   'label' => __( 'Left', 'brevo-campaign-generator' ) ),
							array( 'value' => 'centre', 'label' => __( 'Centred', 'brevo-campaign-generator' ) ),
							array( 'value' => 'right',  'label' => __( 'Right', 'brevo-campaign-generator' ) ),
						),
					),
					array( 'key' => 'bg_color',    'label' => __( 'Background Colour', 'brevo-campaign-generator' ),       'type' => 'color',  'default' => '#ffffff' ),
					...
					array( 'key' => 'icon_color',  'label' => __( 'Icon Colour', 'brevo-campaign-generator' ),             'type' => 'color',  'default' => '#ffffff' ),
					array( 'key' => 'font_size',   'label' => __( 'Heading Font Size (px)', 'brevo-campaign-generator' ),  'type' => 'range',  'default' => 13, 'min' => 11, 'max' => 20, 'step' => 1 ),
					array( 'key' => 'icon_size',   'label' => __( 'Icon Size (px)', 'brevo-campaign-generator' ),          'type' => 'range',  'default' => 40, 'min' => 24, 'max' => 60, 'step' => 4 ),
