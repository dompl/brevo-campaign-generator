		...
		return [
			...
			[
				...
				'variants' => [
					...
					[
						'id'              => 'hero-split-img-left',
						'label'           => 'Image Left — Dark',
						'description'     => 'Image left, text panel right. Dark background, white text.',
						'type'            => 'hero_split',
						'indicator_color' => '#1a1a2e',
						'settings'        => [
							'image_side'      => 'left',
					...
					[
						'id'              => 'hero-split-light',
						'label'           => 'Image Right — Light',
						'description'     => 'Text panel left on a warm cream background, image right.',
						'type'            => 'hero_split',
						'indicator_color' => '#f5f0eb',
						'settings'        => [
							'image_side'      => 'right',
							'text_bg_color'   => '#f5f0eb',
					...
					[
						'id'              => 'hero-split-bold-red',
						'label'           => 'Image Left — Bold Red',
						'description'     => 'Image left, bold red text panel right.',
						'type'            => 'hero_split',
						'indicator_color' => '#e63529',
						'settings'        => [
							'image_side'      => 'left',
							'text_bg_color'   => '#e63529',
							'headline_color'  => '#ffffff',
							'subtext_color'   => 'rgba(255,255,255,0.85)',
							'cta_bg_color'    => '#ffffff',
							'cta_text_color'  => '#e63529',
							'cta_border_radius' => 50,
							'headline'        => 'New Arrival',
							'subtext'         => 'Be the first to get yours',
							'cta_text'        => 'Shop Now',
							'padding_top'     => 44,
							'padding_bottom'  => 44,
						],
