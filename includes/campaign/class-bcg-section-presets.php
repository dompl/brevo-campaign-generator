			...
			[
				...
				'variants' => [
					...
					[
						'id'              => 'divider-dashed',
						'label'           => 'Dashed Line',
						'description'     => 'Dashed border — adds texture and rhythm between sections.',
						'type'            => 'divider',
					...
					[
						'id'              => 'divider-dotted',
						'label'           => 'Dotted Line',
						'description'     => 'Dotted border — playful visual separator.',
						'type'            => 'divider',
					...
					[
						'id'              => 'divider-double',
						'label'           => 'Double Line',
						'description'     => 'Double border — formal, structured visual separator.',
						'type'            => 'divider',
						'indicator_color' => '#555555',
						'settings'        => [
							'type'          => 'divider',
							'color'         => '#555555',
							'thickness'     => 3,
					...
					[
						'id'              => 'divider-accent-dashed',
						'label'           => 'Brand Dashed',
						'description'     => 'Dashed brand-colour rule — energetic, on-brand separator.',
						'type'            => 'divider',
						'indicator_color' => '#e63529',
						'settings'        => [
							'type'          => 'divider',
